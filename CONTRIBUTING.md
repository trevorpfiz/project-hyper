...
When contributing to `WellChart`, whether on GitHub or in other community spaces:

- Be respectful, civil, and open-minded.
- Before opening a new pull request, try searching through the [issue tracker](https://github.com/trevorpfiz/wellchart/issues) for known issues or fixes.
...
To not waste your time implementing a change that has already been declined, or is generally not needed, start by [opening an issue](https://github.com/trevorpfiz/wellchart/issues/new/choose) describing the problem you would like to solve.
...
```bash
gh repo fork trevorpfiz/wellchart
```
